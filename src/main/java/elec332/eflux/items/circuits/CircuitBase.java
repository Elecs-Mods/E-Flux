...
public abstract class CircuitBase extends Item implements ICircuit{
    ...
    public static IInventory get(ItemStack stack){
        if (stack == null || !(stack.getItem() instanceof ICircuit))
            throw new IllegalArgumentException("Item not instance of ICircuit");
        return new getInv(stack);
    }

    private static class getInv extends BasicInventory implements IInventory{
        private getInv(ItemStack stack){
